...
function WelcomePart() {
  ...
  return (
    <div className=" bg-white pl-[252px]  max-mij:pl-[144px] max-md:pl-[73px] max-sm:pl-[16px] flex max-md:flex-col">
      ...
      <div className="w-[50%] max-md:w-full relative max-md:h-[400px]">
        <Image src="/images/welcome-part.png" fill alt="Image-welcome-part" className="w-full h-full" objectFit="cover" />
      </div>
    </div>
  );
}
