...
import ForWomanSlider from "../slider/for-man-woman-slider/for-womanSlider";
  ...
  return (
    <div className="flex flex-col gap-[64px] max-md:gap-[40px] pb-[120px]">
      <div className="px-[252px] max-xl:px-[144px] max-mij:px-[142px]  max-md:px-[73px] max-sm:px-[16px]">
        <h2 className="text-[52px] max-mij:text-[44px] max-md:text-[34px] max-sm:text-[24px] font-railway">для Женщин</h2>
      </div>
