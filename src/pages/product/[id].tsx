...
function Product() {
  const { filteredProduct, dataProductMaterial } = useProductInfo();
  return (
    <div className="px-[252px] max-lg:px-[142px] max-m:px-[73px] max-sm:px-4 flex flex-col gap-10 my-10">
      ...
      <div className="flex gap-4 max-md:flex-col">
        <DesktopProduct dataProductMaterial={dataProductMaterial} />
        <MobileProduct dataProductMaterial={dataProductMaterial} />
